...
public class Familia {
	...
	@MapKeyColumn(name="nome_tel")
	private Map <String, String> telefones_familia = new HashMap<>();
	...
	private RedeReferenciada redeEncaminhou;
	...
	public RedeReferenciada getRedeEncaminhou() {
		return redeEncaminhou;
	}

	public void setRedeEncaminhou(RedeReferenciada redeEncaminhou) {
		this.redeEncaminhou = redeEncaminhou;
		redeEncaminhou.setFamilia(this);
	}
	...
	public void setTelefone(Map<String, String> telefones) {
